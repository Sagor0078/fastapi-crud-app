...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', postgresql.ENUM('todo', 'in_progress', 'completed', name='taskstatus'), nullable=False, server_default='todo'),
        sa.Column('priority', postgresql.ENUM('low', 'medium', 'high', name='taskpriority'), nullable=False, server_default='medium'),
